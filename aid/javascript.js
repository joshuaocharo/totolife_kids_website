...
{
    var alphaChars = "OOOOOOOOOOOOOOOOOOOOOO";
    var generatedString = '';
...
function generateQA(){
    ...
    x=randomInt(alphaChars.length)
    for(var i = 0; i < size; i++) {
        generatedString += alphaChars[x];
    }
    ...
    correctAnswer=x;
    document.getElementById("question").innerHTML=generatedString;
