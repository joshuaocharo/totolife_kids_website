...
var question_number_easy_one = [
	[ "<div class='img_questionare'><img src='../pic/lvl5/ABCDEQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "A,B,C,D,E" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/AHKMTQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "A,H,K,M,T" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/CKSYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "C,K,S,Y,Z" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/DKRXYQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "D,K,R,X,Y" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/FGHIJQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "F,G,H,I,J" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/FLRVWQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "F,L,R,V,W" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/HIJQWQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "H,I,J,Q,W" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/IMQRSQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "I,M,Q,R,S" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/KLMNOQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "K,L,M,N,O" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/LMNSYQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "L,M,N,S,Y" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/OPQVWQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "O,P,Q,V,W" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/PQRSTQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "P,Q,R,S,T" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/TUXYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "T,U,X,Y,Z" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/UVWXYQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "U,V,W,X,Y" ],
	[ "<div class='img_questionare'><img src='../pic/lvl5/VWXYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "V,W,X,Y,Z" ],
];
...
function q_easy1(){
	...
	ctx.innerHTML += "<div id='level'><h1 class='animated infinite flash' id='level1'>Level 5.1 / 5.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy1' maxlength='9' onkeyup='toeasy1();'> <input onclick='easy1()' type='button' value='SUBMIT' class='button2'></center>";
...
function easy1(){
	...
	if(answer_e_1 == question_number_easy_one[ran_e_1][2])
	{
		...
		ctx.innerHTML += "<a href='../html/LVL5.html'><div class='des'><img src='../pic/tryagain.png' height='50px' width='150px' id='refresh'></div>";
	}
}
...
function q_easy2(){
	ctx = _("ctx");
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 5.2 / 5.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy2' maxlength='9' onkeyup='toeasy2();'> <input onclick='easy2()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
...
function easy2(){
	...
	if(answer_e_2 == question_number_easy_two[ran_e_2][2])
	{
		...
		ctx.innerHTML += "<div class='sounds'><embed src='../pic/failed.mp3' autostart='true' height='0px'></div>";
		ctx.innerHTML += "<div class='des'><img src='../pic/cry.png' height='300px' width='200px' id='cry'></a></center></div>";
		ctx.innerHTML += "<a href='../html/LVL5.html'><div class='des'><img src='../pic/tryagain.png' height='50px' width='150px' id='refresh'></a></center></div>";
	}
}
...
function q_easy3(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 5.3 / 5.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy3' maxlength='9' onkeyup='toeasy3();'> <input onclick='easy3()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function q_easy4(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 5.4 / 5.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy4' maxlength='9' onkeyup='toeasy4();'> <input onclick='easy4()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function q_easy5(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 5.5 / 5.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy5' maxlength='9' onkeyup='toeasy5();'> <input onclick='easy5()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function easy5(){
	...
	if(answer_e_5 == question_number_easy_five[ran_e_5][2])
	{
		...
		ctx.innerHTML += "<div class='sounds'><embed src='../pic/passed.mp3' autostart='true' height='0px'></div>";
		ctx.innerHTML += "<div class='des'><img src='../pic/happy.png' height='300px' width='200px' id='happy' class='animated infinite bounce'></a></center></div>";
		ctx.innerHTML += "<div class='des'><a href='LVL6.html'><img src='../pic/proceed4.png' height='50px' width='150px' onclick='easy_f()' id='proceed'></a></div>";
	}
	else {
