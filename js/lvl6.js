...
var question_number_easy_one = [
	[ "<div class='img_questionare'><img src='../pic/lvl6/ABCDEFQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "A,B,C,D,E,F" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/AHOPWXQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "A,H,O,P,W,X" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/AIQVWXQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "A,I,Q,V,W,X" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/BGINOWQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "B,G,I,N,O,W" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/BJRUVZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "B,J,R,U,V,Z" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/CJQRSTQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "C,J,Q,R,S,T" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/DKQRSXQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "D,K,Q,R,S,X" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/EKQVYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "E,K,Q,V,Y,Z" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/FNQWYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "F,N,Q,W,Y,Z" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/GHIJKLQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "G,H,I,J,K,L" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/JQRSXYQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "J,Q,R,S,X,Y" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/LPRTUXQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "L,P,R,T,U,X" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/MNOPQRQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "M,N,O,P,Q,R" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/STUVWXQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "S,T,U,V,W,X" ],
	[ "<div class='img_questionare'><img src='../pic/lvl6/UVWXYZQ.png' width='850px' height='400px'></div>", "Identify the missing letters!", "U,V,W,X,Y,Z" ],
...
function q_easy1(){
	...
	ctx.innerHTML += "<div id='level'><h1 class='animated infinite flash' id='level1'>Level 6.1 / 6.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy1' maxlength='11' onkeyup='toeasy1();'> <input onclick='easy1()' type='button' value='SUBMIT' class='button2'></center>";
...
function easy1(){
	...
	if(answer_e_1 == question_number_easy_one[ran_e_1][2])
	{
		...
		ctx.innerHTML += "<a href='../html/LVL6.html'><div class='des'><img src='../pic/tryagain.png' height='50px' width='150px' id='refresh'></div>";
	}
}
...
function q_easy2(){
	ctx = _("ctx");
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 6.2 / 6.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy2' maxlength='11' onkeyup='toeasy2();'> <input onclick='easy2()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
...
function easy2(){
	...
	if(answer_e_2 == question_number_easy_two[ran_e_2][2])
	{
		...
		ctx.innerHTML += "<div class='sounds'><embed src='../pic/failed.mp3' autostart='true' height='0px'></div>";
		ctx.innerHTML += "<div class='des'><img src='../pic/cry.png' height='300px' width='200px' id='cry'></a></center></div>";
		ctx.innerHTML += "<a href='../html/LVL6.html'><div class='des'><img src='../pic/tryagain.png' height='50px' width='150px' id='refresh'></a></center></div>";
	}
}
function toeasy2(){
...
function q_easy3(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 6.3 / 6.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy3' maxlength='11' onkeyup='toeasy3();'> <input onclick='easy3()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function q_easy4(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 6.4 / 6.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy4' maxlength='11' onkeyup='toeasy4();'> <input onclick='easy4()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function q_easy5(){
	ctx.innerHTML = "<div id='level'><h1 class='animated infinite flash' id='level11'>LEVEL 6.5 / 6.5</h1></div>";
	...
	ctx.innerHTML += "<center><input type='text' id='easy5' maxlength='11' onkeyup='toeasy5();'> <input onclick='easy5()' type='button' value='SUBMIT' class='button2'></center><br><br>";
	ctx.innerHTML += "<center><div id='result'></div></center>";
}
...
function easy5(){
	...
	if(answer_e_5 == question_number_easy_five[ran_e_5][2])
	{
		...
		ctx.innerHTML += "<div class='sounds'><embed src='../pic/passed.mp3' autostart='true' height='0px'></div>";
		ctx.innerHTML += "<div class='des'><img src='../pic/happy.png' height='300px' width='200px' id='happy' class='animated infinite bounce'></a></center></div>";
		ctx.innerHTML += "<div class='des'><a href='LVL7.html'><img src='../pic/proceed5.png' height='50px' width='150px' onclick='easy_f()' id='proceed'></a></div>";
	}
	else {
